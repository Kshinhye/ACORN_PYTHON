...
print(sess.run(hypothesis, feed_dict={x:[5]}))        # [5.247036]
print(sess.run(hypothesis, feed_dict={x:[2.5]}))      # [2.3855639]
print(sess.run(hypothesis, feed_dict={x:[1.5, 3.3]})) # [1.2409748 3.301235 ]